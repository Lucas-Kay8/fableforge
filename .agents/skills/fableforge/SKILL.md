...
根据视频话题，自动选择以下 10 套体系之一：
1. **高级商务杂志风**：深蓝 + 米白 + 少量金色，端庄楷体 / 宋体。
2. **科技增长蓝**：科技蓝 + 白色 + 青色高亮，现代感利落字体。
3. **黑金战略感**：黑色 + 金色 + 深红，厚重榜书体。
4. **新中式理性风**：墨绿/赭石 + 米白 + 朱砂红，书法体/行楷。
5. **极简白底观点风**：纯黑 + 白色 + 单一强调色，大标题体。
6. **温暖访谈纪实风**：暖橙/驼色 + 米白 + 深灰，手写体/圆润字体。
7. **数据图表决策风**：深灰蓝 + 酸橙绿 + 白色，现代干练字体。
8. **深色霓虹 AI 风**：纯黑 + 霓虹紫/蓝 + 白色，未来发光体。
9. **红蓝冲突辩题风**：红色 + 蓝色 + 白色（强对比），粗犷有力。
10. **小红书醒目标题风**：亮橙/粉红 + 白色，可爱手写圆体。
